...
from command import option_names_from_option_list
...
def process_merge(command_options):
    ...
    if command_options.has_key('merge'):
        ...
        if not merge == 'auto' or not options['merge'] == 'import':
            log.info("merge option %s is not acceptable, change to default value 'auto'"%options['merge'])
            merge = 'auto'
    return merge
...
def create_outpath(command_options, project_type):
    if project_type == "publican":
        file_type = "pot"
    elif project_type == "software":
        file_type = "po" 
...
#
#################################
def help_info(option_sets, command_options, args):
    if args:
        process_command(args)
    else:
        print_usage()

def list_project(option_sets, command_options, args):
    """
...
def project_info(option_sets, command_options, args):
    """
...
def version_info(option_sets, command_options, args):
    """
...
def create_project(option_sets, command_options, args):
    """
...
def create_version(option_sets, command_options, args):
    """
...
def po_pull(option_sets, command_options, args):
    """
    ...
    outpath = create_outpath(command_options, project_config)    
...
def po_push(option_sets, command_options, args):
    """
    ...
    if importpo:
        zanatacmd.push_command(zanata, filelist, tmlfolder, project_id, iteration_id, copytrans, "software", import_param)
    else:
        zanatacmd.push_command(zanata, filelist, tmlfolder, project_id, iteration_id, copytrans)

def publican_pull(option_sets, command_options, args):
    """
...
def publican_push(option_sets, command_options, args):
    """
